            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <motion.div
                  ...
                  className="mt-8"
                >
                  <button className="bg-orange-600 text-white px-6 py-2 rounded hover:bg-orange-700 transition-colors font-medium text-sm">
                    Let&apos;s talk →
                  </button>
                </motion.div>
              </motion.div>
            ...
            {relatedServices.map((service, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="inline-flex items-center gap-2 text-orange-500 hover:text-orange-600 transition-colors">
